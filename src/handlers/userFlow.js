...
export function handleProjectIdInput(ctx, projectService, userService) {
  ...
  const rewardMessage = [
    ...
    'Чтобы мы смогли его отправить, пожалуйста, оставьте отзыв на маркетплейсе и напишите здесь пару слов, что вы его опубликовали.',
    'И сразу пришлём ссылку на скачивание 💚'
  ].join('\n');
